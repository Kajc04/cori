function Msgbox(){
    return  <div id="ms"> 
    <svg xmlns="http://www.w3.org/2000/svg" width="80px" height="80px" fill="rgb(110, 124, 204)" className="msg" viewBox="0 0 16 16">
...
<div id="text-error">
  <p> Sorry ! the message service is no longer available in your location . Please to try later ♥</p>
  <br/><br/><div id="little">  

    © 2021 from K.Assocau, Inc. All rights reserved</div>
</div>
